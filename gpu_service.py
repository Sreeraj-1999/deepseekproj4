...
def generate_llm_response():
    ...
    try:
        ...
        logger.info(f"Generating {response_type} response with DeepSeek model")
        ...
        # Extract only final answer (after </think>)
                ...
                for new_text in streamer:
                    ...
                    if "</think>" in clean_text:
                        ...
                        if any(stop in clean_text for stop in ['ANSWER:', 'Answer:', '---', 'Step-by-step', '\nNote:', '\n\n\n']):
                            break
                        if clean_text:
                            yield f"data: {json.dumps({'type': 'answer', 'content': clean_text})}\n\n"
